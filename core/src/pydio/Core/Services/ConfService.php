...
class ConfService
{
     ...
     * @return string
     */
    public static function bootstrapCoreConf($confName){
        $jsonFile = PYDIO_DATA_PATH . "/plugins/boot.conf/bootstrap.json";
        if(is_file($jsonFile)){
            $data = json_decode(file_get_contents($jsonFile), true);
            if(isSet($data["core.conf"][$confName])){
                return $data["core.conf"][$confName];
            }
        }
        return "";
    }
     ...
     */
    public static function init($installPath=PYDIO_INSTALL_PATH, $pluginDir="plugins")
    {
    ...
    private function initInst()
    {
        ...
        $this->configs["JS_DEBUG"] = PYDIO_CLIENT_DEBUG;
        $this->configs["SERVER_DEBUG"] = PYDIO_SERVER_DEBUG;
    ...
    public static function clearAllCaches(){
        ...
        CacheService::deleteAll(PYDIO_CACHE_SERVICE_NS_SHARED);
    ...
    protected function getConfInst($varName)
    {
        ...
        if (defined("PYDIO_".$varName)) {
            return constant("PYDIO_".$varName);
        }
        return null;
    }
    /**
     ...
     */
    public static function getGlobalConf($varName, $coreType = "pydio")
    {
     ...
     * @return mixed
     */
    public static function getContextConf(ContextInterface $ctx, $varName, $coreType = "pydio"){
