...
class Context implements ContextInterface
{
    ...
    public function getUser()
    {
        ...
        if(isSet($this->userId)){
            if(SessionService::has(SessionService::USER_KEY)){
                $uK = SessionService::fetch(SessionService::USER_KEY);
                if($uK !== null && $uK->getId() === $this->userId){
                    $this->userObject = $uK;
                    return $this->userObject;
                }
            }
    ...
    public function getUrlBase()
    {
        ...
        return "pydio://".$this->userId."@".$this->getRepositoryId();
    }
