...
class UrlUtils
{
    ...
    {
        $parts = self::mbParseUrl(str_replace(array("#", "?"), array("__PYDIO_FRAGMENT__", "__PYDIO_MARK__"), $path));
        $parts["path"] = str_replace(array("__PYDIO_FRAGMENT__", "__PYDIO_MARK__"), array("#", "?"), $parts["path"]);
        return $parts;
    }
}