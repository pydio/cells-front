...
class ApiRouter
{
    ...
    public function __construct($base, $cacheOptions = []){
        ...
        $this->cacheOptions = array_merge([
            ...
            "cacheFile" => PYDIO_CACHE_DIR."/plugins_api2routes.php"
        ], $cacheOptions);
    }
    ...
    public function configureRoutes(\FastRoute\RouteCollector &$r){
        ...
        $configObject = json_decode(file_get_contents(PYDIO_INSTALL_PATH . "/" . PYDIO_PLUGINS_FOLDER . "/core.pydio/routes/api2.json"), true);
