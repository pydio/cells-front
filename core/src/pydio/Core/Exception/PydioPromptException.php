...
define('PYDIO_PROMPT_EXCEPTION_PROMPT', 'PYDIO_PROMPT_EXCEPTION_PROMPT');
define('PYDIO_PROMPT_EXCEPTION_CONFIRM', 'PYDIO_PROMPT_EXCEPTION_CONFIRM');
define('PYDIO_PROMPT_EXCEPTION_ALERT', 'PYDIO_PROMPT_EXCEPTION_ALERT');
