...
class ServerEncoding extends AbstractTest
{
    ...
    public function doTest()
    {
        ...
        if ($locale == 'C') {
            ...
            $this->failedInfo .= "<p class='suggestion'><b>Suggestion</b> : Set the PYDIO_LOCALE parameter to the correct value in the <i>conf/bootstrap_conf.php</i> file. You can also set this value using the installer form (next step).</p>";
            return FALSE;
        }
