...
class Upload extends AbstractTest
{
    ...
    public function doTest()
    {
        ...
        if (ConfService::getGlobalConf("PYDIO_TMP_DIR") != "") {
            $tmpDir = ConfService::getGlobalConf("PYDIO_TMP_DIR");
        }
        if (defined("PYDIO_TMP_DIR") && PYDIO_TMP_DIR !="") {
            $tmpDir = PYDIO_TMP_DIR;
        }
        ...
        if (!$this->testedParams["Upload Tmp Dir Writeable"]) {
            ...
            $this->failedInfo .= "<p class='suggestion'><b>Suggestion</b> : Set the PYDIO_TMP_DIR parameter in the <i>conf/bootstrap_conf.php</i> file</p>";
            return FALSE;
        }
