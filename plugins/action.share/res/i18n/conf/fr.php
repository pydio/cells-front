...
"Where to store the metadata file : LOCAL means a hidden file will be created in each folder, GLOBAL means that one file will be created in DATA_PATH/plugins/action.share folder." => "Où stocker le fichier de métadonnées : 'LOCAL' signifie qu'un fichier caché sera créé dans chaque répertoire, 'GLOBAL' signifie qu'un seul fichier sera créé dans le répertoire DATA_PATH/plugins/action.share .",
