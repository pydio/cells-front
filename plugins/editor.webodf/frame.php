...
$FILE_URL = InputFilter::securePath(InputFilter::sanitize($_GET["file"], 5));
...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        function init()
        {
            ...
            window.odfcanvas.load("../../" + window.parent.ajxpServerAccessPath + "&get_action=download&file=<?php echo $FILE_URL; ?>");
