...
class S3CacheService implements \Aws\CacheInterface
{
    ...
    public function get($key) {
        return CacheService::fetch(PYDIO_CACHE_SERVICE_NS_NODES, $key);
    }
    ...
    public function set($key, $value, $ttl = 0) {
        CacheService::save(PYDIO_CACHE_SERVICE_NS_NODES, $key, $value, $ttl);
    }
    ...
    public function remove($key) {
        CacheService::delete(PYDIO_CACHE_SERVICE_NS_NODES, $key);
    }
}