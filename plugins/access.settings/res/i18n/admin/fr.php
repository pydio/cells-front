...
$mess=array(
    ...
    "ws.1" => "Gérer les DataSources",
    "ws.2" => "Fermer les Datasources",
    "ws.3" => "+ dépôt",
    "ws.4" => "+ datasource",
    "ws.4b" => "+ stratégie versioning",
    "ws.5" => "Alias",
    "ws.6" => "Nouveau Dépôt",
    "ws.7" => "Nouvelle DataSource",
    ...
    "ws.45" => "Comme ce dépôt utilise dans ses paramètres des valeurs comme PYDIO_USER ou PYDIO_GROUP_*, le contenu affiché varie en fonction de l'utilisateur
    ...
    "ws.74" => "Utiliser le formulaire pour créer une nouvelle DataSource.",
    "ws.75" => "Une datasource définit un point d'accès à vos données.",
    "ws.76" => "Pydio aggrègera toutes vos datasources en un seul arbre sur lequel vous assignez des droits via les workspaces.",
    ...
    "perfs.debug.error" => "Attention, l'une des constante PYDIO_SERVER_DEBUG, PYDIO_CLIENT_DEBUG ou PYDIO_SKIP_CACHE a la valeur 'True'!",
