...
$mess=array(
    ...
    "ws.1" => "Manage DataSources",
    "ws.2" => "Close DataSources",
    "ws.3" => "+ workspace",
    "ws.4" => "+ datasource",
    "ws.4b" => "+ version policy",
    "ws.5" => "Slug",
    "ws.6" => "New Workspace",
    "ws.7" => "New DataSource",
    "ws.8" => "Existing DataSource",
    "ws.9" => "Datasource Nodes",
    "ws.10" => "Select a DataSource",
    ...
    "ws.45" => "As its parameters are using 'PYDIO_USER' or 'PYDIO_GROUP_*' keywords, the contents of
    ...
    "ws.74" => "Use the form on the right to create a new DataSource. ",
    "ws.75" => "A DataSource defines where your data is stored.",
    "ws.76" => "Pydio will aggregate all your datasources into one master tree, on which you can assign rights using workspaces.",
    ...
    "perfs.debug.error" => "Warning, one of PYDIO_SERVER_DEBUG, PYDIO_CLIENT_DEBUG or PYDIO_SKIP_CACHE is set to True!",
