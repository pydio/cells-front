...
$mess=array(
    ...
    "ws.45" => "Dado que se está usando 'PYDIO_USER' o 'PYDIO_GROUP_*', el contenido de
    ...
    "perfs.debug.error" => "Atención, ¡PYDIO_SERVER_DEBUG, PYDIO_CLIENT_DEBUG o PYDIO_SKIP_CACHE está ajustado como True!",
