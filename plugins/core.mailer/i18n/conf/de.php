...
$mess = array(
    ...
    "Body Layout" => "Text",
    "Main Layout for the email body, use HTML for send nice emails, and use the PYDIO_MAIL_BODY keyword for the real content." => "Der E-Mail-Text (HTML für Formatierung möglich). Die Variable PYDIO_MAIL_BODY fügt den Inhalt ein.",
    "Layout Folder" => "Layout-Ordner",
    "Extract the main layout from a localized file. Will prevail on the previous parameter, make sure to have an PYDIO_MAIL_BODY in the layout file." => "Das Layout der E-Mails aus einer übersetzten Datei laden (überschreibt den 'Text'-Parameter). Die Layout-Datei muss PYDIO_MAIL_BODY enthalten.",
