...
$mess = array(
    ...
    "Main Layout for the email body, use HTML for send nice emails, and use the PYDIO_MAIL_BODY keyword for the real content." => "Mise en page du corps du mail. Vous pouvez utiliser du HTML et le mot-clé PYDIO_MAIL_BODY pour le contenu réel.",
    "Layout Folder" => "Répertoire des mise-en-pages",
    "Extract the main layout from a localized file. Will prevail on the previous parameter, make sure to have an PYDIO_MAIL_BODY in the layout file." => "Extraire la mise en page d'un fichier localisé. Ceci prendra le pas sur le paramêtre précédent, attention à bien utiliser PYDIO_MAIL_BODY dans le fichier.",
