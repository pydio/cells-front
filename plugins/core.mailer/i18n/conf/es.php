...
$mess = array(
    ...
    "Main Layout for the email body, use HTML for send nice emails, and use the PYDIO_MAIL_BODY keyword for the real content." => "Diseño principal del cuerpo del correo, usa HTML para enviar correos con diseños bonitos y usa PYDIO_MAIL_BODY para el contenido real.",
    "Layout Folder" => "Directorio del Diseño",
    "Extract the main layout from a localized file. Will prevail on the previous parameter, make sure to have an PYDIO_MAIL_BODY in the layout file." => "Extrae al diseño principal el contenido de los archivos. Esta opción prevalece sobre la anterior, asegurate de usar PYDIO_MAIL_BODY en el archivo de diseño.",
