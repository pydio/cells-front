...
define('PYDIO_CACHE_SERVICE_NS_SHARED', 'shared');
define('PYDIO_CACHE_SERVICE_NS_NODES', 'nodes');
...
abstract class AbstractCacheDriver extends Plugin
{
     ...
     */
    abstract public function getCacheDriver($namespace=PYDIO_CACHE_SERVICE_NS_SHARED);
