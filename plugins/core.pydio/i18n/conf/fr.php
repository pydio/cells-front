...
"Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!" => "Essaye d'utiliser les identifiants Pydio de l'utilisateur pour se connecter. Attention, 'PYDIO_SESSION_SET_CREDENTIALS' doit-être activé !",
...
"Prefilled label for the new repository, you can use the PYDIO_USER keyworkd in it." => "Libellé prérempli pour le nouveau dépôt, vous pouvez y utiliser le mot clef 'PYDIO_USER'.",
...
"Use PHP MySQLi extension" => "Utiliser l'extension PHP MySQLi",
"Use MySQLi" => "Utiliser MySQLi",
"Ascending" => "Ascendant",
"Descending" => "Descendant",
"Name" => "Nom",
"Modification date" => "Modifié",
"File size" => "Taille",
"File Type" => "Type",
"Read Only" => "Lecture Seule",
"Read and Write" => "Lecture / Ecriture",
"Write Only (upload)" => "Upload seulement",
