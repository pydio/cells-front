...
"Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!" => "Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!",
"User name" => "User name",
...
"Prefilled label for the new repository, you can use the PYDIO_USER keyworkd in it." => "Prefilled label for the new workspace, you can use the PYDIO_USER keyworkd in it.",
