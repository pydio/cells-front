...
"Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!" => "Verwendet die Pydio Anmeldeinformationen des Benutzers. Achtung, dafür muss die Einstellung PYDIO_SESSION_SET_CREDENTIALS aktiviert sein.",
...
"Prefilled label for the new repository, you can use the PYDIO_USER keyworkd in it." => "Standard-Beschreibung der Arbeitsumgebung (Es ist möglich, den Platzhalter 'PYDIO_USER' zu verwenden)",
