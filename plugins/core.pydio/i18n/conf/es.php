...
"If not inferred directly from the current Pydio URI plus the public download folder name, replace the public access URL here." => "Si no se infiere directamente del URI de Pydio y el directorio de descargas, reemplaza la URL pública de acceso aquí.",
...
"Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!" => "Comprueba los credenciales del usuario para conectarse a Pydio. Atención, ¡la variable PYDIO_SESSION_SET_CREDENTIALS debe estar configurada como true!",
...
"Prefilled label for the new repository, you can use the PYDIO_USER keyworkd in it." => "Etiqueta pregenerada para el nuevo workspace, puedes usar PYDIO_USER en este campo.",
