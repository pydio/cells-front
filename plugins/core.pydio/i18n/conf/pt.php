...
"Try to use the current Pydio user credentials for connecting. Warning, the PYDIO_SESSION_SET_CREDENTIALS config must be set to true!" => "Tente usar os dados actuais de utilizador do Pydio para se ligar. ATENÇÃO: O ficheiro de configuração 'PYDIO_SESSION_SET_CREDENTIALS' deverá estar marcado como Verdadeiro(True)!",
...
"Prefilled label for the new repository, you can use the PYDIO_USER keyworkd in it." => "Etiqueta Pré-Definida para uma nova Área de Trabalho, pode utilizar a palavra 'PYDIO_USER' neste campo.",
